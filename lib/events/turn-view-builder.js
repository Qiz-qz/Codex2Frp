  ...
  for (const [eventIndex, event] of coalescePairedUserEvents(events).entries()) {
    ...
    if (event.type === 'message' && event.role === 'user') {
      ...
      if (event.delivery === 'steer') {
        ...
        // Current ChatGPT emits task_started before the first user message and
        // includes that turn id on the message. It is the primary input, not a
        // second steer presentation. Attach it to the empty running shell.
